<div class="site-section bg-image overlay" style="background-image: url({{asset('src/app/images/hero_1.jpg')}});">
    <div class="container">
      <div class="row justify-content-center align-items-center">
        <div class="col-md-8 text-center testimony">
          <img src="{{asset('src/app/images/person_4.jpg')}}" alt="Image" class="img-fluid w-25 mb-4 rounded-circle">

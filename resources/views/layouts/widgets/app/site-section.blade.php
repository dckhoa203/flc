<div class="site-section pb-0">
    ...
    <div class="future-blobs">
      <div class="blob_2">
        <img src="{{asset('src/app/images/blob_2.svg')}}" alt="Image">
      </div>
      <div class="blob_1">
        <img src="{{asset('src/app/images/blob_1.svg')}}" alt="Image">
      </div>
    </div>
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-7 align-self-end"  data-aos="fade-left" data-aos-delay="200">
          <img src="{{asset('src/app/images/person_transparent.png')}}" alt="Image" class="img-fluid">
        </div>
      </div>
    </div>
  </div>